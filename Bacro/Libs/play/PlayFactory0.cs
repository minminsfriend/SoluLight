    ...
    public partial class PlayFactory : Player
    {
        ...
        public override void PlayMacro(string cate, string command)
        {
            ...
            else if (cate == "햄생산트루히요")
            {
                ...
                {
                    case "생산":
                        playmacro_Trujillo(150 / 3, true); // 연구 병행 
                        break;
                    case "햄다섯번":
                        playmacro_Trujillo(5, false);
                        break;
                    case "햄한번만":
                        playmacro_Trujillo(1, false);// 발주서 1 장
                        break;
                    case "생산만한번":
                        playmacro_Trujillo_1();
                        break;
                    case "음식만들기":
                        MacroRunning = true;
                        product_foods_Trujillo();
                        MacroRunning = false;
                        break;
                    case "교역소로":
                        MacroRunning = true;
            ...
            else if (cate == "햄관리트루히요")
            {
                ...
                {
                    case "생산":
                        playmacro_Trujillo_G(150 / 3, true); // 연구 병행 
                        break;
                    case "햄다섯번":
                        //playmacro_Trujillo(5, false);
                        break;
